...
function Info() {
    return (
        <div>
            <h1>About Us</h1>
            <p className="qoute" >Bangladesh has always been a country rich in culture, art, and literature. However, it is also the land where artistic flair is being taken for granted or being considered “just a hobby”. Our website aims to change that by providing a platform for the artists and talented minds in Dhaka (for now) who just need an opportunity to flaunt their skills and earn through their creativity.<br/><br/>
            Most of the time, when we post an artwork or take a photo, we do not receive the exposure we deserve. In another similar scenario, when we want to do commissions, we are unable to find the right client to deliver to or even the right medium to advertise our self-made products through.<br/><br/>And this is where esscre comes in.
